						...
						<div class="modal-header">
							...
							<form name="help" method="post">
								<div class="modal-body modal-spa">
									<div class="writ">
										<h4>Contact Us for any HELP or booking issues</h4>
											<ul>
												...
												<li class="descrip">
									<input class="special" type="text" placeholder="Tell Us about your needs"  name="description" required="">
												</li>
													<div class="clearfix"></div>
											</ul>
											<div class="sub-bn">
												<form>
													<button type="submit" name="submit" class="subbtn">Send</button>
												</form>
											</div>
									</div>
								</div>
