...
if (isset($_POST['submit2'])) {
	...
	$todate = $_POST['todate'];
	$dat1 = strtotime($fromdate);
	$dat2 = strtotime($todate);
	...
	if ($lastInsertId) {
		$msg = "You have Successfully Book this Package for $diff days";
	} else {
...
<head>
	<title>TGS | Package Details</title>
					...
					<form name="book" method="post">
						<div class="selectroom_top">
							...
							<div class="col-md-8 selectroom_right wow fadeInRight animated" data-wow-delay=".5s">
								...
								<div class="grand">
									<p>Per Day</p>
									<h3>Amount: <?php echo htmlentities($result->PackagePrice); ?>/.</h3>
								</div>
							</div>
